package org.atanasov.casebook.config;
...
public class RewriteServletConfig extends HttpConfigurationProvider {
    ...
    public Configuration getConfiguration(final ServletContext context) {
        return ConfigurationBuilder.begin()
                ...
                .addRule(Join.path(FRIENDS_URL).to("/faces/views/friends.xhtml"))
                .addRule(Join.path(PROFILE_URL).to("/faces/views/profile.xhtml"));
    }
}
