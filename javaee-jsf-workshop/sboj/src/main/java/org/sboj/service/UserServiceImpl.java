...
import org.sboj.util.ModelMapperWrapper;
...
import static org.sboj.constants.Constants.PASSWORD_ATTR;
...
public class UserServiceImpl implements UserService {
    ...
    private static final String PASSWORDS_MATCH_ERROR = "Passwords do not match.";
    ...
    public void register(UserRegisterServiceModel model) {
        ...
        if (!validationService.arePasswordsMatching(model.getPassword(), model.getConfirmPassword())) {
            throw new IllegalArgumentException(PASSWORDS_MATCH_ERROR);
        }
